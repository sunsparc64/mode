...
#  post_list.push("echo 'nameserver 8.8.8.8' >> #{resolv_conf}")
  ...
  post_list.push("echo \"deb http://#{$default_ubuntu_mirror} $UBUNTU_RELEASE-security main restricted universe multiverse\" >> /etc/apt/sources.list")
  post_list.push("echo \"deb-src http://#{$default_ubuntu_mirror} $UBUNTU_RELEASE-security main restricted universe multiverse\" >> /etc/apt/sources.list")
  post_list.push("echo \"deb http://#{$default_ubuntu_mirror} $UBUNTU_RELEASE-updates main restricted universe multiverse\" >> /etc/apt/sources.list")
  post_list.push("echo \"deb-src http://#{$default_ubuntu_mirror} $UBUNTU_RELEASE-updates main restricted universe multiverse\" >> /etc/apt/sources.list")
  post_list.push("echo \"deb http://#{$default_ubuntu_mirror} $UBUNTU_RELEASE-proposed main restricted universe multiverse\" >> /etc/apt/sources.list")
  post_list.push("echo \"deb-src http://#{$default_ubuntu_mirror} $UBUNTU_RELEASE-proposed main restricted universe multiverse\" >> /etc/apt/sources.list")
  post_list.push("echo \"deb http://#{$default_ubuntu_mirror} $UBUNTU_RELEASE-backports main restricted universe multiverse\" >> /etc/apt/sources.list")
  post_list.push("echo \"deb-src http://#{$default_ubuntu_mirror} $UBUNTU_RELEASE-backports main restricted universe multiverse\" >> /etc/apt/sources.list")
  post_list.push("")
